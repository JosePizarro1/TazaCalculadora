...
fetch_best_rate("VES", "SELL")
fetch_best_rate("VES", "BUY")
fetch_best_rate("MXN", "SELL")
fetch_best_rate("MXN", "BUY")
fetch_best_rate("COP", "SELL")
fetch_best_rate("COP", "BUY")
fetch_best_rate("ARS", "SELL")
fetch_best_rate("ARS", "BUY")
